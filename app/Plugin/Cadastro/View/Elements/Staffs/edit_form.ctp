...
<?php echo $this->Form->input('id'); ?>
	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="form-group">
				<label for="nome">Quinzena:</label>
				<?php echo $this->Form->input('quinzena', array('div' => false, 'label' => false, 'class' => 'form-control', 'type' => 'select', 'empty' => 'Selecionar Quinzena', 'options' => array(1 => '1ª) Primeira', 2 => '2ª) Segunda') ) ); ?>
			</div>

		</div>
	</div>
	<button type="submit" class="btn btn-default"><i class="fa fa-save"></i> Salvar Informações</button>

	<a target="_blank" href="<?php echo $this->Html->url( array('plugin' => 'exportacao', 'controller' => 'designacao', 'action' => 'index', $this->request->data['Staff']['id']) ); ?>" class="btn btn-default">Exportar Designações</a>
	<a target="_blank" href="<?php echo $this->Html->url( array('plugin' => 'exportacao', 'controller' => 'designacao', 'action' => 'index', $this->request->data['Staff']['id'], 'view') ); ?>" class="btn btn-default">Visualizar Designações</a>
