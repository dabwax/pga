		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-default">
					<h3 class="page-title">Adicionar Cargo</h3>
					<hr>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<?php echo $this->Form->input('Role.aircraft_model', array('div' => false, 'label' => false, 'class' => 'form-control', 'empty' => 'Selecionar', 'type' => 'select', 'options' => array(1 => 'Sim', 2 => 'Não') ) ); ?>
							</div>

							<div class="form-group">
								<label for="nome">Obrigatório Base?</label>
								<?php echo $this->Form->input('Role.base', array('div' => false, 'label' => false, 'class' => 'form-control', 'type' => 'select', 'options' => array(1 => 'Sim', 2 => 'Não', 'empty' => 'Selecionar') ) ); ?>
							</div>
