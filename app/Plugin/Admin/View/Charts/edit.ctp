...
<?php echo $this->Form->create('Chart'); ?>
	<fieldset>
		<legend><?php echo __('Edit Chart'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Chart.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Chart.id'))); ?></li>
