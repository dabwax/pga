...
echo "                                <option value=\"light\" />Light\n"; 
echo "                                <option value=\"dark\" />Dark\n"; 
echo "                                <option value=\"red\" />Red\n"; 
echo "                            </select>\n"; 
echo "                        </div>\n"; 
echo "                    </div>\n"; 
echo "                </div>\n"; 
echo "                <div class=\"button demo selected\">\n"; 
echo "                    <span><label>Home</label></span>\n"; 
echo "                    <div class=\"settings\">\n"; 
echo "                        <div class=\"row\">\n"; 
echo "                            <label>Demo:</label>\n"; 
echo "                            <select id=\"demo_type\">\n"; 
echo "                                <option value=\"1\" />Demo 1: Combination (delete turned on)\n"; 
echo "                                <option value=\"2\" />Demo 2: Blog Post\n"; 
echo "                                <option value=\"3\" />Demo 3: Single Column (left)\n"; 
echo "                                <option value=\"4\" />Demo 4: Single Column (right)\n"; 
echo "                                <option value=\"5\" />Demo 5: Single Column (center & responsive)\n"; 
echo "                            </select>\n"; 
echo "                        </div>\n"; 
echo "                    </div>\n"; 
echo "                </div>\n"; 
