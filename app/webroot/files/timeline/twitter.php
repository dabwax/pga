...
echo "                <div class=\"button twitter selected\">\n"; 
echo "                    <span><label>Twitter Timeline</label></span>\n"; 
echo "                    <div class=\"settings\">\n"; 
echo "                        <div class=\"row\">\n"; 
echo "                            <label>Search:</label>\n"; 
echo "                            <input type=\"text\" placeholder=\"Enter a keyword\" id=\"hashtag\" required />\n"; 
echo "                        </div>\n"; 
echo "                        <div class=\"row\">\n"; 
echo "                            <input type=\"button\" value=\"Submit\" onclick=\"twitterSearch();\" />\n"; 
echo "                        </div>\n"; 
echo "                    </div>\n"; 
echo "                </div>\n"; 
